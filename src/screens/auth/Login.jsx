...
const createStyles = (colors) => StyleSheet.create({
    ...
    card: { borderRadius: 16, paddingHorizontal: 25, width: '100%', height: 440, backgroundColor: colors.primaryContainer },
    ...
    signupContainer: { marginTop: 28, position: 'absolute', bottom: 20, alignSelf: 'center' },
